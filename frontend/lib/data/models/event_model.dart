  ...
  factory EventModel.fromJson(Map<String, dynamic> json) {
    ...
    try {
      parsedEventTimestamp =
          DateTime.parse(json['event_timestamp'] as String).toLocal();
    } catch (e) {
      print(
          "EventModel Error parsing event_timestamp '${json['event_timestamp']}': $e. Using current time as fallback.");
    ...
    return EventModel(
      ...
      locationAddress: json['location']
          as String, // Backend sends address in 'location' field
      ...
      imageUrl: json['image_url']
          as String?, // This will be the presigned URL from backend
      locationCoords:
          json['location_coords'] != null && json['location_coords'] is Map
              ? LocationPoint.fromJson(
                  json['location_coords'] as Map<String, dynamic>)
              : null,
