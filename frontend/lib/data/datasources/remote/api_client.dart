...
class ApiClient {
  ...
  ApiClient({http.Client? client})
    ...
    if (apiKey.isEmpty) {
      const errorMessage =
          "FATAL ERROR: API_KEY environment variable not set during build. ApiClient cannot operate.";
      //print(errorMessage);
    ...
    //print(
       // "ApiClient initialized. Base URL: $baseUrl, API Key Set: ${apiKey.isNotEmpty}");
  }
  ...
  Future<dynamic> post(String endpoint, {String? token, dynamic body}) async {
    ...
    try {
      ...
      //print("ApiClient POST Error (Timeout) for $endpoint: $e");
      throw Exception("Request timed out.");
    } on SocketException catch (e) {
      //print("ApiClient POST Error (Socket) for $endpoint: $e");
      throw Exception("Network error.");
    } on TlsException catch (e) {
      //print("ApiClient POST Error (TLS) for $endpoint: $e");
      throw Exception("Secure connection failed.");
    } on http.ClientException catch (e) {
      //print("ApiClient POST Error (Client) for $endpoint: $e");
      throw Exception("HTTP client error: ${e.message}");
    } catch (e) {
      //print("ApiClient POST Error (Unknown) for $endpoint: $e");
      throw Exception("An unexpected error occurred: $e");
    }
  }
  ...
  Future<dynamic> put(String endpoint, {String? token, dynamic body}) async {
    ...
    try {
      ...
      //print("ApiClient PUT Error (Timeout) for $endpoint: $e");
      throw Exception("Request timed out.");
    } on SocketException catch (e) {
      //print("ApiClient PUT Error (Socket) for $endpoint: $e");
      throw Exception("Network error.");
    } on TlsException catch (e) {
      //print("ApiClient PUT Error (TLS) for $endpoint: $e");
      throw Exception("Secure connection failed.");
    } on http.ClientException catch (e) {
      //print("ApiClient PUT Error (Client) for $endpoint: $e");
      throw Exception("HTTP client error: ${e.message}");
    } catch (e) {
      //print("ApiClient PUT Error (Unknown) for $endpoint: $e");
      throw Exception("An unexpected error occurred: $e");
    }
  }

  Future<dynamic> delete(String endpoint,
      {String? token, dynamic body, Map<String, String>? queryParams}) async {
    ...
    try {
      ...
      final streamedResponse =
          await _httpClient.send(request).timeout(_defaultTimeout);
      final response = await http.Response.fromStream(streamedResponse);
      return _handleResponse(response, "DELETE $endpoint");
    } on TimeoutException catch (e) {
      //print("ApiClient DELETE Error (Timeout) for $endpoint: $e");
      throw Exception("Request timed out.");
    } on SocketException catch (e) {
      //print("ApiClient DELETE Error (Socket) for $endpoint: $e");
      throw Exception("Network error.");
    } on TlsException catch (e) {
      //print("ApiClient DELETE Error (TLS) for $endpoint: $e");
      throw Exception("Secure connection failed.");
    } on http.ClientException catch (e) {
      //print("ApiClient DELETE Error (Client) for $endpoint: $e");
      throw Exception("HTTP client error: ${e.message}");
    } catch (e) {
      //print("ApiClient DELETE Error (Unknown) for $endpoint: $e");
      throw Exception("An unexpected error occurred: $e");
    }
  }
  ...
  Future<dynamic> multipartRequest(
    ...
    try {
      ...
      //print("ApiClient Multipart Error (Timeout) for $endpoint: $e");
      throw Exception(
          "Upload timed out. Please check your connection and try again.");
    } on SocketException catch (e) {
      //print("ApiClient Multipart Error (Socket) for $endpoint: $e");
      throw Exception("Network error during upload.");
    } on TlsException catch (e) {
      //print("ApiClient Multipart Error (TLS) for $endpoint: $e");
      throw Exception("Secure connection failed during upload.");
    } on http.ClientException catch (e) {
      //print("ApiClient Multipart Error (Client) for $endpoint: $e");
      throw Exception("HTTP client error during upload: ${e.message}");
    } catch (e) {
      //print("ApiClient Multipart Error (Unknown) for $endpoint: $e");
  ...
  dynamic _handleResponse(http.Response response, String requestInfo) {
    ...
    final responseBodySnippet = response.body.substring(
    ...
    if (statusCode >= 200 && statusCode < 300) {
      ...
      String errorMessage =
          'API request to $requestInfo failed with status $statusCode';
      String? errorDetail;
      try {
        if (response.body.isNotEmpty) {
          final errorBody = json.decode(response.body);
          errorDetail =
              errorBody['detail']?.toString() ?? 'Unknown API error detail';
        ...
        errorMessage =
            'Server error $statusCode: Invalid error response format.';
        if (response.body.isNotEmpty) {
          errorMessage += ' Body: $responseBodySnippet...';
        }
      } catch (e) {
        errorMessage =
            'Server error $statusCode: Failed to parse error response: $e';
      }
