...
class EventService {
  ...
  Future<Map<String, dynamic>> getEventDetails(int eventId,
      {String? token}) async {
    try {
  ...
  Future<List<dynamic>> getCommunityEvents(int communityId,
  ...
  Future<List<dynamic>> getNearbyEvents({
    ...
    int limit =
        20, // Backend for /location/events/nearby is assumed to support these
    int offset = 0,
  }) async {
    try {
      final queryParams = {
  ...
  Future<Map<String, dynamic>> updateEvent({
    ...
    try {
      ...
      if (eventTimestamp != null) {
        fields['event_timestamp'] = eventTimestamp.toUtc().toIso8601String();
      }
      if (maxParticipants != null) {
        fields['max_participants'] = maxParticipants.toString();
      }
      if (latitude != null) fields['latitude'] = latitude.toString();
      if (longitude != null) fields['longitude'] = longitude.toString();
