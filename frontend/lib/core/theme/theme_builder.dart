...
ThemeData buildThemeFromPalette(AppPalette palette) {
  ...
  return baseTheme.copyWith(
    ...
    colorScheme: ColorScheme(
      ...
      outline:
          palette.outlineButtonBorder, // Use the border color for M3 outline
      ...
      inversePrimary:
          palette.secondary, // Often the accent can work as inverse primary
      // Container colors
      primaryContainer:
          Color.alphaBlend(palette.primary.withOpacity(0.1), palette.surface),
      onPrimaryContainer: palette.onPrimary,
      secondaryContainer:
          Color.alphaBlend(palette.secondary.withOpacity(0.1), palette.surface),
      onSecondaryContainer: palette.onSecondary,
      tertiaryContainer:
          Color.alphaBlend(palette.tertiary.withOpacity(0.1), palette.surface),
      onTertiaryContainer: palette.onTertiary,
      errorContainer:
          Color.alphaBlend(palette.error.withOpacity(0.1), palette.surface),
      onErrorContainer: palette.onError,
      surfaceBright: Color.lerp(
          palette.surface, Colors.white, 0.05), // Slightly brighter surface
      surfaceDim: Color.lerp(
          palette.surface, Colors.black, 0.05), // Slightly dimmer surface
    ),
    appBarTheme: AppBarTheme(
      backgroundColor:
          palette.surface, // Common to use surface for M3 style AppBar
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        padding: const EdgeInsets.symmetric(
            ...
            vertical:
                ThemeConstants.smallPadding + 4), // M3 buttons often taller
      ),
    ),
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(
            color: palette.outlineButtonBorder,
            width: 1), // M3 outline is typically 1px
        shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(ThemeConstants.buttonBorderRadius)),
        padding: const EdgeInsets.symmetric(
            horizontal: ThemeConstants.mediumPadding,
            vertical: ThemeConstants.smallPadding + 4),
        textStyle:
    ...
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
      fillColor: palette.surfaceVariant.withOpacity(
          palette.brightness == Brightness.dark
              ? 0.3
              : 0.5), // More subtle fill
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(
            ThemeConstants.borderRadius / 2), // M3 fields often less rounded
        borderSide: BorderSide(
            color: palette.outlineButtonBorder
                .withOpacity(0.7)), // Use outline color from palette
      ),
      ...
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(ThemeConstants.borderRadius / 2),
        borderSide:
            BorderSide(color: palette.outlineButtonBorder.withOpacity(0.5)),
      ),
    ...
    chipTheme: ChipThemeData(
      ...
      padding: const EdgeInsets.symmetric(
          ...
          vertical: ThemeConstants.smallPadding / 1.5),
      shape: RoundedRectangleBorder(
          borderRadius:
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      selectedIconTheme:
          IconThemeData(size: 24, color: palette.bottomNavSelected),
      unselectedIconTheme:
          IconThemeData(size: 24, color: palette.bottomNavUnselected),
    ...
    textTheme: baseTheme.textTheme.copyWith(
      ...
      displayLarge: baseTheme.textTheme.displayLarge
          ?.copyWith(color: palette.onBackground, fontFamily: 'Poppins'),
      ...
      titleSmall: baseTheme.textTheme.titleSmall?.copyWith(
          color: palette.onSurface.withOpacity(0.85),
          fontFamily: 'Poppins',
          fontWeight: FontWeight.w500),
      bodyLarge: baseTheme.textTheme.bodyLarge?.copyWith(
          color: palette.onBackground, fontFamily: 'Poppins', height: 1.5),
      bodyMedium: baseTheme.textTheme.bodyMedium?.copyWith(
          color: palette.onBackground.withOpacity(0.85),
          fontFamily: 'Poppins',
          height: 1.4),
      bodySmall: baseTheme.textTheme.bodySmall?.copyWith(
          color: palette.onBackground.withOpacity(0.7),
          fontFamily: 'Poppins',
          height: 1.3),
      labelLarge: baseTheme.textTheme.labelLarge?.copyWith(
          color: palette.onSecondary,
          fontFamily: 'Poppins',
          fontWeight: FontWeight.w600), // Text on ElevatedButton
      labelMedium: baseTheme.textTheme.labelMedium?.copyWith(
          color: palette.outlineButtonForeground,
          fontFamily: 'Poppins',
          fontWeight: FontWeight.w500), // Text on OutlinedButton/TextButton
