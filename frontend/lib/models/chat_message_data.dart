...
class ChatMessageData {
  ...
  ChatMessageData({
    ...
    List<MediaItemDisplay>? media, // Make media optional in constructor, default to empty
  ...
  factory ChatMessageData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['media'] != null && json['media'] is List) {
      try {
        parsedMedia = (json['media'] as List<dynamic>)
            ...
            .map((item) => MediaItemDisplay.fromJson(item as Map<String, dynamic>))
            .toList();
      } catch (e) {
        print("Error parsing media items in ChatMessageData: $e. Media data: ${json['media']}");
    ...
    return ChatMessageData(
      ...
      profile_image_url: json['profile_image_url'] as String?, // This field was for sender's avatar, not message media
  ...
  Map<String, dynamic> toJson() => {
    ...
    'media': media.map((item) => { // Basic serialization for media if needed
      'id': item.id,
      'url': item.url,
