...
NotificationType _notificationTypeFromString(String? typeString) {
  ...
  switch (typeString) {
    ...
    case 'post_reply': return NotificationType.postReply;
    case 'reply_reply': return NotificationType.replyReply;
    case 'post_vote': return NotificationType.postVote;
    case 'reply_vote': return NotificationType.replyVote;
    case 'post_favorite': return NotificationType.postFavorite;
    case 'reply_favorite': return NotificationType.replyFavorite;
    case 'event_invite': return NotificationType.eventInvite;
    case 'event_reminder': return NotificationType.eventReminder;
    case 'event_update': return NotificationType.eventUpdate;
    case 'community_invite': return NotificationType.communityInvite;
    case 'community_post': return NotificationType.communityPost;
    case 'new_community_event': return NotificationType.newCommunityEvent;
    case 'user_mention': return NotificationType.userMention;
    default:
...
class NotificationModel {
  ...
  factory NotificationModel.fromJson(Map<String, dynamic> json) {
    if (json['id'] == null || json['type'] == null || json['is_read'] == null || json['created_at'] == null) {
      print("Error parsing NotificationModel: Missing required fields in JSON: $json");
      throw FormatException("Missing required fields in NotificationModel JSON", json);
    }
    ...
    try {
      ...
      print("Error parsing notification created_at '${json['created_at']}': $e. Using current time as fallback.");
    ...
    return NotificationModel(
      ...
      actor: json['actor'] != null
          ? NotificationActorInfo.fromJson(json['actor'] as Map<String, dynamic>)
          : null,
      relatedEntity: json['related_entity'] != null
          ? NotificationRelatedEntityInfo.fromJson(json['related_entity'] as Map<String, dynamic>)
          : null,
    );
  }
