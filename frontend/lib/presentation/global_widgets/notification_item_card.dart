...
// import '../../core/constants/app_constants.dart'; // Not directly used if default avatar is handled by actor?.avatarUrl
...
class NotificationItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /* ... UI and Theme logic uses context, no direct path changes needed within the method for now ... */
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    final bool isRead = notification.isRead;
    final Color cardColor = isRead
        ? (isDark
            ? ThemeConstants.backgroundDarker.withOpacity(0.7)
            : Colors.grey.shade100)
        : (isDark
            ? ThemeConstants.backgroundDark.withOpacity(0.9)
            : Colors.white);
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () {
          onTap?.call();
          if (!isRead && onMarkAsRead != null) onMarkAsRead!();
        },
        child: Padding(
              ...
              Stack(children: [
                CircleAvatar(
                  ...
                  child: notification.actor?.avatarUrl == null ||
                          notification.actor!.avatarUrl!.isEmpty
                      ? Icon(
