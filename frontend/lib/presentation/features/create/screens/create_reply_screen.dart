...
class _CreateReplyScreenState extends State<CreateReplyScreen> {
  ...
  Future<void> _pickImages() async {
    ...
    try {
      final List<XFile> pickedXFiles =
          await picker.pickMultiImage(imageQuality: 75, maxWidth: 1024);
          ...
          for (var xfile in pickedXFiles) {
            if (_pickedImageFiles.length < 3)
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                    content: Text('Maximum 3 images for replies.'),
      ...
      /* print("Image picker error (reply): $e"); */ if (mounted)
  ...
  Future<void> _submitReply() async {
    ...
    final replyService = Provider.of<ReplyService>(context,
        listen: false); // Use typedef or actual class
    ...
    try {
      ...
      if (mounted)
        setState(() {
          ...
          _isLoading = false;
        }); /* print("CreateReplyScreen error: $e"); */
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final String appBarTitle = widget.parentReplyId != null
        ? (widget.parentReplyContent != null &&
                widget.parentReplyContent!.isNotEmpty
            ? 'Reply to Comment'
            : 'Reply to Reply')
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Attach Images (Optional, max 3)",
                        ...
                        children: [
                          ClipRRect(
                            borderRadius: BorderRadius.circular(
                                ThemeConstants.borderRadius / 1.5),
                            child: Image.file(_pickedImageFiles[index],
              ...
              OutlinedButton.icon(
                ...
                label: Text(
                    _pickedImageFiles.isEmpty ? "Add Images" : "Add More",
