// frontend/lib/presentation/features/common/screens/main_navigation_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

// --- Screen Imports ---
import '../../notifications/screens/notifications_screen.dart'; // Corrected path
import '../../profile/screens/profile_screen.dart'; // Corrected path

// --- New Stub Screen Imports ---
import '../../feed/screens/home_feed_screen.dart'; // Corrected path
import '../../explore/screens/explore_screen.dart'; // Corrected path
import '../../chat/screens/chat_list_screen.dart'; // Corrected path

// --- Create Action Screens/Dialogs ---
import '../../create/screens/create_post_screen.dart'; // Corrected path
// Global widget, path is now from global_widgets
import '../../../global_widgets/create_event_dialog.dart';
import '../../communities/screens/create_community_screen.dart'; // Corrected path
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) => CreateEventDialog(
                      ...
                      onSubmit: (title, description, locationAddress, dateTime,
                          maxParticipants, imageFile, latitude, longitude) {
                        print('Event created: $title');
                        // TODO: Call event creation service
                      },
                    ),
                  );
                },
  ...
  Widget build(BuildContext context) {
    ...
    // Ensure clampedSelectedIndex handles edge cases correctly or ensure _screens isn't empty
    final clampedSelectedIndex =
        _screens.isNotEmpty ? _selectedIndex.clamp(0, _screens.length - 1) : 0;

    String currentAppBarTitle =
        _appBarTitles.isNotEmpty ? _appBarTitles[clampedSelectedIndex] : "App";
    bool showMainAppBar = true;

    // ExploreScreen has its own AppBar with TabBar
    if (clampedSelectedIndex == 1 &&
        _screens.length > 1 &&
        _screens[1] is ExploreScreen) {
                        ...
                        Positioned(
                          ...
                          child: Container(
                            padding: EdgeInsets.all(
                                unreadNotificationCount > 9 ? 2.5 : 3.5),
