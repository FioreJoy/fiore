...
import 'package:provider/provider.dart';
import '../../../../data/datasources/remote/post_api.dart';       // Corrected Path & File Name
import '../../../../data/datasources/remote/community_api.dart';  // Corrected Path & File Name
import '../../../../data/datasources/remote/event_api.dart';      // Corrected Path & File Name
...
// --- Global Widgets ---
import '../../../global_widgets/custom_card.dart';                 // Corrected Path
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        margin: const EdgeInsets.only(
                            right: ThemeConstants.smallPadding),
                        padding: const EdgeInsets.symmetric(
                          horizontal: ThemeConstants.mediumPadding,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        '${community['image']}?w=200&auto=format&fit=crop'),
                    fit: BoxFit.cover,
