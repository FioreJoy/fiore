...
class FavoriteService {
  ...
  Future<Map<String, dynamic>> addFavorite({
    ...
    if (!((postId != null && replyId == null) || (postId == null && replyId != null))) {
      throw ArgumentError("FavoriteService Error: Provide exactly one of postId or replyId.");
    }
    ...
    try {
      ...
      if (response is Map<String, dynamic>) {
        return response;
         ...
         return {"message": "Favorited successfully", "success": true, "new_counts": {}}; // Counts might need separate fetch
      }
      else {
  ...
  Future<Map<String, dynamic>> removeFavorite({
    ...
    final String endpoint = postId != null
        ? ApiEndpoints.postFavorite(postId) // Same endpoint, different method (DELETE)
    ...
    try {
      ...
      if (response is Map<String, dynamic>) {
        return response;
         ...
         return {"message": "Unfavorited successfully", "success": true, "new_counts": {}}; // Counts might need separate fetch
      }
      else {
